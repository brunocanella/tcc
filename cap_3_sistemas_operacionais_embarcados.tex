...
Para que os aplicativos tenham acesso aos serviços oferecidos sem que haja um comprometimento de sua integridade, o SO oferece rotinas de acesso aos serviços. A quantidade de serviços vária conforme implementação do SO, sendo o mínimo oferecido as operações de gerenciamento de processos, memória e \criarSigla{Entrada e Saída}{E/S}. A \reffig{cap3_os_services} apresenta uma hierarquia de chamada dos serviços do SO.
...
A \reffig{cap3_io_abstraction} ilustra como a camada de E/S abstraí o dispositivo de hardware, garantindo a flexibilidade do sistema.
